...
<a class="btn btn-primary" href="tambahhh" role="button">Tambah Data</a>
<br>
<br>
...
<table class="table">
  ...
  <tr>
    ...
    <td><?php echo $row['keadaan_barang']; ?></td>
    <td><?php echo $row['jumlah_barang']; ?></td>
    <td>
        <a href="edit.php?id=1" class="btn btn-primary">Edit</a> <a href="delete.php" class="btn btn-primary">Hapus</a>
    </td>
  </tr>
  <?php
      }
