...
<a class="btn btn-primary" href="tambahh.php" role="button">Tambah Data</a>
<br>
<br>
...
<table class="table">
  ...
  <tr>
    ...
    <td>
        <a href="edit.php?id=1" class="btn btn-primary">Edit</a> <a href="deletee.php" class="btn btn-primary">Hapus</a>
    </td>
  </tr>
  <?php
      }
